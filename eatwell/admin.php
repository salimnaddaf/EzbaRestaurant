...
<head>
  ...
  <style>
    html,body{
    background-image: url("images/ezba-ba.jpg");
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="site-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active"><a href="index.php#section-about" class="nav-link">About</a></li>
          <li class="nav-item active"><a href="index.php#section-offer" class="nav-link">Offer</a></li>
          <li class="nav-item active"><a href="ezbamenuo.html" class="nav-link">Menu</a></li>
          <li class="nav-item active"><a href="index.php#section-news" class="nav-link">News</a></li>
          <li class="nav-item active"><a href="index.php#section-gallery" class="nav-link">Gallery</a></li>
          <li class="nav-item active"><a href="index.php#section-contact" class="nav-link">Contact</a></li>
        </ul>
      </div>
    </div>
  </nav>
